...
// resolves a name, or looks at the running kernel. What depends on a value that was not
// supplied is left out whole and named in the Output, so that the caller can wait for
// it (ADR 0016).
package networkd
